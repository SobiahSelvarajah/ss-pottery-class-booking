        ...
        <section className="px-4 py-6">
            <div className="max-w-6xl mx-auto">
                ...
                <select 
                    ...
                    className="w-full md:w-64 border border-neutral-light rounded-md px-3 py-2 bg-neutral-white text-neutral-dark focus:outline-none focus:ring-2 focus:ring-clay-brown transition"
                >
